 ...
 *
 * @package   DPT_Basic_Link_Widget
 * @author    Wilfried Reiter <wilfried.reiter@devpoint.at>
 * @license   GPL-2.0+
 * @link      http://wordpress.org/extend/plugins/basic-link-widget
 * @copyright 2015 Wilfried Reiter
 *
 * @basic-link-widget
 * Plugin Name:       Basic Link Widget
 * Plugin URI:        http://wordpress.org/extend/plugins/basic-link-widget
 ...
 * Text Domain:       basic-link-widget
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Domain Path:       /languages
 * GitHub Plugin URI: https://github.com/devpoint/wordpress-basic-link-widget
 */
...
function dpt_load_basic_link_widget() {
	register_widget('DPT_Basic_Link_Widget');
}
add_action('widgets_init', 'dpt_load_basic_link_widget');

/**
 * Basic Link Widget Class
 */
class DPT_Basic_Link_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'dpt_basic-link-widget';
     ...
     * @var      string
     */
    protected $widget_text_domain = 'basic-link-widget';
	...
	public function __construct() 
	{
		...
		parent::__construct(
			...
			__('Basic Link Widget', $this->get_widget_text_domain()),
			array(
				'description' => __('Link to internal or external content.', $this->get_widget_text_domain()),
	 ...
	 * Will look in the plugins/basic-link-widget directory in a theme
	...
	/**
	 * Print widget target link title
	 *
     * @since  1.0.0
     *
     * @param  array $instance 
	 * @return void
	 */
	public function the_target_title(&$instance)
	{
	}
